...
`,xn=function(){var e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:wn,r=y.useContext(W),t=r.csp;y.useEffect(function(){on(e,"@ant-design-icons",{prepend:!0,csp:t})},[])},Tn=["icon","className","onClick","style","primaryColor","secondaryColor"],g={primaryColor:"#333",secondaryColor:"#E6E6E6",calculated:!1};function On(n){var e=n.primaryColor,r=n.secondaryColor;g.primaryColor=e,g.secondaryColor=r||V(e),g.calculated=!!r}function Sn(){return f({},g)}var h=function(e){var r=e.icon,t=e.className,o=e.onClick,a=e.style,c=e.primaryColor,l=e.secondaryColor,s=K(e,Tn),u=g;if(c&&(u={primaryColor:c,secondaryColor:l||V(c)}),xn(),hn(H(r),"icon should be icon definiton, but got ".concat(r)),!H(r))return null;var i=r;return i&&typeof i.icon=="function"&&(i=f(f({},i),{},{icon:i.icon(u.primaryColor,u.secondaryColor)})),P(i.icon,"svg-".concat(i.name),f({className:t,onClick:o,style:a,"data-icon":i.name,width:"1em",height:"1em",fill:"currentColor","aria-hidden":"true"},s))};h.displayName="IconReact";h.getTwoToneColors=Sn;h.setTwoToneColors=On;const I=h;function Y(n){var e=X(n),r=L(e,2),t=r[0],o=r[1];return I.setTwoToneColors({primaryColor:t,secondaryColor:o})}function jn(){var n=I.getTwoToneColors();return n.calculated?[n.primaryColor,n.secondaryColor]:n.primaryColor}var kn=["className","icon","spin","rotate","tabIndex","onClick","twoToneColor"];Y("#1890ff");var w=y.forwardRef(function(n,e){var r,t=n.className,o=n.icon,a=n.spin,c=n.rotate,l=n.tabIndex,s=n.onClick,u=n.twoToneColor,i=K(n,kn),x=y.useContext(W),b=x.prefixCls,d=b===void 0?"anticon":b,Z=an(d,(r={},k(r,"".concat(d,"-").concat(o.name),!!o.name),k(r,"".concat(d,"-spin"),!!a||o.name==="loading"),r),t),T=l;T===void 0&&s&&(T=-1);var q=c?{msTransform:"rotate(".concat(c,"deg)"),transform:"rotate(".concat(c,"deg)")}:void 0,J=X(u),E=L(J,2),Q=E[0],nn=E[1];return y.createElement("span",f(f({role:"img","aria-label":o.name},i),{},{ref:e,tabIndex:T,onClick:s,className:Z}),y.createElement(I,{icon:o,primaryColor:Q,secondaryColor:nn,style:q}))});w.displayName="AntdIcon";w.getTwoToneColor=jn;w.setTwoToneColor=Y;const Pn=w;export{Pn as A,f as _};
